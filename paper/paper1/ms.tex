...
where $\zeta$ is the convolution kernel for rigid body rotation \censorbox{cite ExoJAX} and $\bm{v}$ is the spectral axis represented as relative velocity coordinates.
