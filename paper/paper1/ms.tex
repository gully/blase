...
\begin{figure}[hbt!]
 ...
 \caption{PHOENIX spectrum cloned with blas\'e.  This $T_{\mathrm{eff}}=4100\;$K,  $\log{g}=3.5$ solar metallicity model has over 5,000 individual cloned spectral lines.  The figure zooms in on a $0.7\%$ portion of the large spectral bandwidth that was cloned.  Some conspicuous flaws can be seen near the wings of broad lines, or surrounding blended lines.  Some initialization effects can be seen in this example, suggesting that the cloning procedure requires additional training iterations to achieve the best performance.}
...
\begin{figure}[hbt!]
 ...
 \caption{A zoom in of the region from Figure \ref{fig_cloned_spectrum_demo}.}
