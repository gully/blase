...
\begin{eqnarray}
  \mathsf{M}(\bm{\lambda}_s) = {\displaystyle \prod_{j=1}^{N_{\mathrm{lines}}}  (1-a_j V(\bm{\lambda}_s-\lambda_{c,j}, \sigma_j, \gamma_j) )} \label{equation1}
\end{eqnarray}
...
The computational bottleneck occurs at...
