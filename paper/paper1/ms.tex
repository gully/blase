...
\title{Transfer learning for \'echelle spectroscopy with \texttt{blas\'e} yes}
...
\begin{figure}[hbt!]
    ...
    \caption{PHOENIX spectrum cloned with blas\'e.  This $T_{\mathrm{eff}}=4100\;$K,  $\log{g}=3.5$ solar metallicity model has 11,759 individual cloned spectral lines, each with 3 tuned parameters.  The pictured 25 \AA~ chunk contains 73 spectral lines and represents a mere $<0.7\%$ portion of the entire spectral bandwidth that was cloned.  Some flaws can be seen near the cores of deep lines, or wings of broad lines.}
...
\begin{figure}[hbt!]
    ...
    \caption{A zoom in of the region between the vertical gray bars in Figure \ref{fig_cloned_spectrum_demo}. There are 9 spectral lines in this view.}
