...
It is easier to \edit1{infer} longitudinally asymmetric features than longitudinally symmetric ones, since we assume that we occasionally catch a glimpse of the spot-free limbs and their pristine line profiles.
...
\begin{acknowledgments}
    ...
    \edit1{We thank the anonymous referee for comments that improved the paper.}  \edit2{We thank Phill Cargile, Hajime Kawahara, and Dan Jaffe for pre-print comments that were incorporated into the draft text.}
