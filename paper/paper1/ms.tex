...
\authorcomment1{Need more prose here.}
...
It is easier to reverse-engineer longitudinally asymmetric features than longitudinally symmetric ones.  
The latter requires exact knowledge of the underlying spectral template.  Isolated deep spectral lines constitute the only practical scenario where exact knowledge can be claimed.  Isolated spectral lines may be scarce or absent for M-dwarfs and brown dwarfs where lines blend ostensibly in an inseparable way, counfounding Doppler imaging.
