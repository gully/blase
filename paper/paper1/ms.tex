...
\emph{``A surrogate model, emulator, or discrepancy modeling''}-- The machine learning community is increasingly incorporating physics-based emulation into machine learning models.   \emph{Blas\'e} can be viewed as such a technique, often labeled as ``surrogate models''.
