...
The conversion of spectral line depths to spectral type\citep{1901AnHar..28..129C}---and by extension $T_\mathrm{eff}$ \citep{1925PhDT.........1P}---has occupied a large chunk of stellar spectroscopy in the last century, and the measurement of fundamental stellar properties remains one of the principal applications of astronomical spectroscopy.  Blas\'e as it currently stands does not output fundamental properties, and in fact it takes them \emph{for granted}: you must specify \emph{e.g.} the $T_\mathrm{eff}$, $\log{g}$, [Fe/H], and [$\alpha$/Fe] of your PHOENIX template as Step Zero before that template gets cloned and warped to match data.  So obtaining a $T_\mathrm{eff}$ estimate is impossible.  

Simply put, we seek a function, $f$:
...
The construction and calibration of these ensembles of spectra represents a tremendous amount of work beyond the scope of this paper.  But its inevitable creation represents a major breakthrough for the field of stellar astrophysics.  It would be an extremely precise, accurate, fast, and interpretable way to measure the properties of stars based solely on their high bandwidth \'echelle spectrum.  
