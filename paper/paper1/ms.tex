...
\subsection{Adjustments from the stellar model}
The Telluric clone model proceeds almost identically to the stellar model, with the following modifications.  
