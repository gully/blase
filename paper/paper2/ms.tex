...
\begin{mdframed}
    ...
    between these line properties and the fundamental stellar parameters. We know that there is
    some relation between the two, but we do not even know its functional form. While we have a
    ridiculously large array of methods to choose from, we can start with a simple linear
    regression with a polynomial basis. We can quickly test the efficacy of this method by 
    running it on the line we visualized earlier.
\end{mdframed}
